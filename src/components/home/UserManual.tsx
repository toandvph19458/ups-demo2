        ...
        <div className="custom-container  ">
          <div className="px-[60px] py-[100px] grid grid-cols-[240px,420px,auto] gap-20 shadow-[0px_4px_54px_0px_rgba(0,0,0,0.05)] rounded-[32px] bg-[#FFF]">
            ...
            >
              ...
              >
                <TabsList className="flex flex-col gap-3 my-[42px]">
                  {apps.map((app) => (
                    <TabsTrigger
                      key={app.id}
                      value={app.id.toString()}
                      className={`text-[#111013] text-[18px] font-bold leading-[28px] text-start ${
                        currentApp === app.id
                          ? "border-r-2 border-[#111013] "
                          : "border-none"
                      }`}
                    >
                      {app.name}

      ...
      <div className="custom-container 3xl:!max-w-[1280px] mt-[120px] mb-[150px]">
        ...
        <div className="bg-[#000] rounded-[24px]">
          <div className="flex items-center justify-between">
            <div
              className="py-[55px] pl-[50px] w-[30%]"
              data-aos="fade-up"
              data-aos-delay="200"
            >
              <h3 className="text-[#FFF] text-[40px] font-bold leading-[54px]">
                Đừng bỏ lỡ cơ hội đầu tư của bạn
              </h3>
              <p className="text-[#FFF] text-[18px] font-medium leading-[28px] mt-4 mb-10">
        ...
        {/* section 2 */}
        <div className="mt-[120px]" data-aos="fade-up" data-aos-delay="200">
          ...
          <p className="text-[18px] text-[#111013] font-medium leading-[28px]">

    ...
    <>  
        <div className="mx-auto sm:max-w-xl md:max-w-full lg:max-w-[1600px] px-4 lg:px-20">
          <div className="grid grid-cols-2">
            <div className="flex flex-col gap-4 place-self-end" data-aos="fade-up" data-aos-delay="200">
            ...
            <div className="bg-[#23252B] p-[60px] w-[62%] justify-self-end" data-aos="fade-up" data-aos-delay="600">

    ...
    <div className="custom-container mt-10 lg:mt-[160px]">
      {directors.map((director, index) => {
        return (
          <div
            key={index}
            className={`lg:grid lg:grid-cols-2 lg:gap-[30px] flex flex-col gap-3 mt-6 lg:mt-[30px]`}
          >
            <div
              className={`relative w-full pt-[100%] ${index % 2 !== 0 ? "lg:order-2" : "order-1"}`}
              data-aos="fade-up"
              data-aos-delay="200"
            >
              <NextImg
            ...
            <div
              className={`bg-[#F3F3FB] rounded-[24px] p-5 lg:p-10 pb-[20%] ${index % 2 !== 0 ? "lg:order-1" : "order-2"}`}
              data-aos="fade-up"
              data-aos-delay="600"
            >

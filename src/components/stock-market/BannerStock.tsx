      ...
      <div className="custom-container">
        ...
        <div className="mt-4 block md:hidden">
          <div className="relative mx-auto h-[189px] w-[210px]">
            <NextImg
              src="/assets/image/banner-ck-mb.png"
              alt="Capi"
              objectFit="cover"
              className=""
            />
          ...
          <div
            ...
            data-aos-delay="400"
          >
            <h1 className="text-[32px] font-bold text-[#D0F500]">Cổ Phiếu</h1>
            <p className="mt-2 font-bold text-[#FFF]">
              Đặc quyền vượt trội tại Chứng khoán UPS
            </p>
          </div>
        </div>
        <div
          ...
          data-aos-delay="200"
        >
          <p className="text-sm font-bold text-[#FFF] lg:text-base">
            Tham gia giao dịch Cổ phiếu là giải pháp đơn giản và dễ dàng giúp
            bạn hiện thực hóa ước mơ <br className="hidden md:block" />
            tăng trưởng tài chính và chinh phục những đỉnh cao cuộc sống.
          </p>
